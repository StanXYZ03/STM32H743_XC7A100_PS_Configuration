...
HD_PWD='D:/CubeMX/STM32H743_XC7A100_PS_Configuration/Mouse_Key/Mouse_Key.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ch9350_spi_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ch9350_spi_top.tcl
