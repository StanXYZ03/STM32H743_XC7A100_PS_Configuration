...
HD_PWD='D:/CubeMX/STM32H743_XC7A100_PS_Configuration/Mouse_Key/Mouse_Key.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ch9350_spi_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ch9350_spi_top.tcl -notrace
