...
HD_PWD='D:/CubeMX/STM32H743_XC7A100_PS_Configuration/Confg-Flash/Confg-Flash.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_flash_bridge_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_flash_bridge_top.tcl
