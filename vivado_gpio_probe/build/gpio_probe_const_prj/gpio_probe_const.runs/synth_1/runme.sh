...
HD_PWD='D:/CubeMX/STM32H743_XC7A100_PS_Configuration/vivado_gpio_probe/build/gpio_probe_const_prj/gpio_probe_const.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_probe_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_probe_top.tcl
