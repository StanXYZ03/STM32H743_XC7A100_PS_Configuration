...
HD_PWD='D:/CubeMX/STM32H743_XC7A100_PS_Configuration/vivado_gpio_probe/build/gpio_probe_const_prj/gpio_probe_const.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_probe_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_probe_top.tcl -notrace
