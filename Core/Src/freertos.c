...
/* USER CODE BEGIN Header_FPGAConfigDefaultTask */
/**
  * @brief  Function implementing the FPGAConfigTask thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_FPGAConfigDefaultTask */
__weak void FPGAConfigDefaultTask(void const * argument)
{
